...
static int ipv6_generate_eui64(u8 *eui, struct net_device *dev)
{
	...
	case ARPHRD_RAWIP:	/* Added by Andy from QCT LTE0045 for LTE related function */
...
static void addrconf_dev_config(struct net_device *dev)
{
	...
	if ((dev->type != ARPHRD_ETHER) &&
	    ...
	    (dev->type != ARPHRD_RAWIP) &&	/* Added by Andy from QCT LTE0045 for LTE related function */
